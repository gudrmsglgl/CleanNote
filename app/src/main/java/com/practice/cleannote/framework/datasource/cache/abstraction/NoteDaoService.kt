package com.practice.cleannote.framework.datasource.cache.abstraction

import com.practice.cleannote.business.domain.model.Note
import com.practice.cleannote.framework.datasource.database.NOTE_PAGINATION_PAGE_SIZE
